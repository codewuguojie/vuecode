...
export class Observer {
  ...
  constructor (value: any) {
    ...
    this.dep = new Dep()
    this.vmCount = 0
    //给value新增一个_ob_属性，值为该value的observer实例，相当于为value打上标记，表示它已经被转化成响应式了，避免重复操作
    def(value, '__ob__', this)
    if (Array.isArray(value)) {//数组走这个逻辑
      if (hasProto) {
 ...
 */
//将一个object转化成可观测对象（参数说明：object:对象，key:对象的key，val:key对应的值）
